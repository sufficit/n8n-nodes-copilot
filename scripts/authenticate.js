...
async function authenticate() {
  try {
    ...
    if (!useExistingGitHubToken) {
      ...
      // EXIBIR TOKEN GITHUB OBTIDO NA TELA
      console.log("\n" + "=".repeat(80));
      console.log("🎉 TOKEN GITHUB OAUTH OBTIDO COM SUCESSO!");
      console.log("=".repeat(80));
      console.log("🔑 TOKEN GITHUB OAUTH:");
      console.log("=".repeat(80));
      console.log(githubToken);
      console.log("=".repeat(80));
      console.log("💡 Este token pode ser usado diretamente como token GitHub Copilot");
      console.log("=".repeat(80));

      // Verificar se pasta results existe antes de salvar
      if (fs.existsSync("./results")) {
        // Salvar token GitHub
        fs.writeFileSync("./results/github-token.txt", githubToken);
        console.log("💾 Token GitHub salvo em: ./results/github-token.txt\n");
      } else {
        console.log("⚠️ Pasta ./results não existe. Token não foi salvo em arquivo.");
        console.log("📁 Crie a pasta ./results se quiser salvar os tokens.\n");
      }
    }
    ...
    // Salvar informações completas apenas se pasta results existir
    if (fs.existsSync("./results")) {
      const fullTokenData = {
      ...
      console.log("⚠️ Pasta ./results não existe. Dados completos não foram salvos.");
      console.log("📁 Crie a pasta ./results se quiser salvar os dados completos.\n");
    }
